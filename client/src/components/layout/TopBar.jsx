...
// Top navigation bar with title, currency selector, theme toggle, alerts bell, user menu
export default function TopBar({
  ...
  return (
    <header className="flex items-center justify-between px-4 sm:px-6 h-14 border-b border-default bg-surface sticky top-0 z-10 gap-3">
      ...
      <div className="flex items-center gap-2 sm:gap-4">
        ...
        <button
          ...
          className="p-1 cursor-pointer bg-transparent border-none text-muted hidden sm:block"
        >
          <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
